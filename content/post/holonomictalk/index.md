...
Joël Ouaknine gave an invited talk on holonomic techniques, periods, and decision problems at Foundations of Software Technology and Theoretical Computer Science conference (FSTTCS 2020). During his talk Joël presented some of our ongoing work on inequality decision problems for low-order holonomic sequences (see [here]({{< relref "/publication/kenison-2021-minimality" >}}) and [here]({{< relref "/publication/kenison-2026-positivity" >}})).  The abstract and recording  for the talk are given below.
