...
During his talk, Ben presented some of our ongoing work on inequality decision problems for low-order holonomic sequences (see [here]({{< relref "/publication/kenison-2021-minimality" >}}) and [here]({{< relref "/publication/kenison-2026-positivity" >}})).  The abstract and recording for the talk are given below. Here are Ben's [slides](https://popl21.sigplan.org/details/POPL-2021-research-papers/69/Dynamical-Systems-and-Program-Analysis).
