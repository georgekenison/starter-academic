...
* Roland Guttenberg (TUM)
  ...
  {{% staticref "/uploads/liar25/guttenberg-liar25.pdf" %}} Slides: &#128462; {{% /staticref %}}
  {{< /spoiler >}}
...
* [Fatemeh Mohammadi](https://www.fatemehmohammadi.com/) (KU Leuven)
  ...
  {{% staticref "/uploads/liar25/mohammadi-liar25.pdf" %}} Slides: &#128462; {{% /staticref %}}
...
on a large family of examples.
  ...
  {{% staticref "/uploads/liar25/safeyeldin-liar25.pdf" %}} Slides: &#128462; {{% /staticref %}}
...
complexity of computing Gröbner bases.
  ...
  {{% staticref "/uploads/liar25/schmitz-liar25.pdf" %}} Slides: &#128462; {{% /staticref %}}
  
  {{< /spoiler >}}

* [Anton Varonka](https://informatics.tuwien.ac.at/people/anton-varonka) (TU Wien)

  {{< spoiler text="**Rational Loop Synthesis**" >}}
