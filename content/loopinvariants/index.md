...
* Mahsa Naraghi (Université Paris Cité)
  ...
  {{< spoiler text="**On the Algebraic Closure of Context-Free Matrix Languages**" >}}

  Let L be a language over a finite alphabet, and let f be a homomorphism from words over this alphabet to n-dimensional square matrices with rational entries. We are interested in the computability of the algebraic closure of the semigroup generated by the set of matrices corresponding to words in L. It was recently shown that this closure is computable when L is a regular language, as demonstrated in work by Hrushovski, Pouly, Ouaknine, and Worrell.

<p>
In this talk, we explore how this result can be extended to broader classes of languages, particularly those defined by finite-index context-free grammars (a strict subclass of context-free languages).
</p>

<p>
This ongoing work is in collaboration with Rida Ait El Manssour, Mahsa Shirmohammadi, and James Worrell.
</p>
